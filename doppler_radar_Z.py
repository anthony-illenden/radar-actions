...
for ds_name in sorted(catalog.datasets):
    ...
    ax.add_feature(USCOUNTIES.with_scale('5m'), linewidth=0.25, zorder=4)
    ...
    img = ax.pcolormesh(x, y, ref_clean2, cmap=metpy.plots.ctables.registry.get_colortable('NWSStormClearReflectivity'), vmin=-35, vmax=80, zorder=5)
